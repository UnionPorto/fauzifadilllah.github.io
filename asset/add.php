                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            <label>Kode Scan</label>
                                                ...
                                                <input class="form-control" type="text" placeholder="<?php echo $test;?>"  value="<?php echo $Kode; ?>"  name="kode_asset" readonly>
                                                <!-- <br> -->
                                                ...
                                                <label>Outlet</label>
                                                <select class="form-control" data-toggle="select" name="Outlet">
  ...
  <th><input type="text" name="kode_asset_detail[]" class="form-control"></th>
            ...
            <th>
                ...
                <hr>
                                                ...
                                                <input class="btn btn-primary btn-block" type="submit" value="Selanjutnya" name="add">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            include_once("../Configure/connection.php");
                                            $i = 0;
                                            $result = mysqli_query($db, "select * from detail_scan where Id_Scan = '$Kode'");
...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js" integrity="sha384-oBqDVmMz9ATKxIep9tiCxS/Z9fNfEXiDAYTujMAeBAsjFuCZSmKbSSUnQlmh/jp3" crossorigin="anonymous"></script>
  ...
  if(isset($_POST['tambahdetail'])) {
            ...
            $Kode = $_POST['kode_asset'];
            $Barcode       = $_POST['search2'];
            $NamaItem       = $_POST['NamaItem'];
            $Qty       = $_POST['Qty'];
 
        
            $query = mysqli_query($db, "INSERT INTO detail_scan(Id,Id_Scan, Nama_Item, Barcode, Qty) VALUES ('','$Kode','$NamaItem','$Barcode','$Qty')");
            echo "<script> Swal.fire({
                ...
                setTimeout(function(){window.location='../asset/add.php?id=$Kode'} , 2000);
  ...
  if(isset($_POST['add'])) {
    ...
    $outlet_ke       = $_POST['outletke'];
      ...
      $query = "INSERT INTO Scan(Id_Karyawan,Kode_Scan,Tanggal_Dibuat,Outlet) VALUES('$Id_User','$Kode_Asset',CURRENT_DATE(),'$Outlet')";
      ...
      echo "<script> Swal.fire({
        ...
        setTimeout(function(){window.location='../asset/adddetail.php?id=$Kode_Asset'} , 100);
