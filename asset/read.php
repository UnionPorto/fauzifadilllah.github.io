                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th>Tanggal Di Approve Admin</th>
                                                <th>Tanggal Di Approve OM</th>
                                                <th>Alasan Di Kembalikan</th>
                                                <th>Status</th>
                                                <th>action</th>
                                        ...
                                        <tbody>
                                            ...
                                            include_once("../Configure/connection.php");
                                            $i = 0;
                                            $result = mysqli_query($db, "select * from asset where status = 'Need Request For Approval' or status = 'Return' ");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $dataketerangan['kode_asset']; ?></td>
                                                    <td><?php echo $dataketerangan['outlet_dari']; ?></td>
                                                    <td><?php echo $dataketerangan['outlet_ke']; ?></td>
                                                    <td><?php echo $dataketerangan['tanggal_dibuat']; ?></td>
                                                    <td><?php echo $dataketerangan['tanggal_approve']; ?></td>
                                                    <td><?php echo $dataketerangan['tanggal_approve_om']; ?></td>
                                                    <td><?php echo $dataketerangan['description']; ?></td>
                                                    <td><?php echo $dataketerangan['status']; ?></td>
