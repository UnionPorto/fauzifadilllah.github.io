                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        $idus = $_GET['id'];
                                ...
                                //   $kodeasset = $_GET['kode_asset'];
          include_once("../configure/connection.php");


              $query = mysqli_query($db, "SELECT * FROM asset where kode_asset = '$iduser' or id = $idus ");
                        ...
                        <div class="card">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="actionedit.php?id=<?php echo $idus; ?>">
      ...
      <div class="panel-body">
        ...
        <!-- gunakan tanda [] untuk menampung array  -->
          ...
          <div class="card">
                        ...
                        <?php 
                if($_SESSION['level']== 'om'){
                    echo '<input class="btn btn-success btn-block" type="submit" value="Terima" name="add">
                    <input class="btn btn-danger btn-block" type="submit" value="Tolak" name="Tolak">
                    ';
