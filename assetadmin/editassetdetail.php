                        ...
                        <div class="card">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-subtitle mb-4">Insert Shift Data</p>
    
                                        <form method="POST" action="actioneditasset.php?id=<?php echo $iduser; ?>">
      ...
      <div class="panel-body">
        ...
        <!-- gunakan tanda [] untuk menampung array  -->
          ...
          <div class="card">
                                        ...
                                        <div class="modal fade" id="exampleModal<?php echo $dataketerangan['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="../asset/actioneditdetail.php?id=<?php echo $dataketerangan['id']; ?>">
                        ...
                        <input class="btn btn-success btn-block" type="submit" value="Update" name="add">
