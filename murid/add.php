...
// Fetch all users data from database
$result = mysqli_query($db, "select * from murid");
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-100">Murid</h4>
    
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">APASMAN</a></li>
                                            <li class="breadcrumb-item active">Murid Data</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Add Murid</h4>
                                        <p class="card-subtitle mb-4">Insert Murid Data</p>
    
                                        <form method="POST" action="add.php">
                                            <div class="form-group" method="POST">

                                                <label>Nama</label>
                                                <input class="form-control" type="text" placeholder="Insert Nama" name="nama" required>
                                                <br>
                                                <label>umur</label>
                                                <input class="form-control" type="text" placeholder="Insert umur" name="umur" required>
                                                <br>
                                           
                                                <label>kelas</label>
                                                <select class="form-control" name="kelas" data-toggle="select2" required>
                                               ...
                                               <br>
                                                <input class="btn btn-primary btn-block" type="submit" value="add" name="addmurid">
                        ...
                        <?php
                            ...
                            try { 
                            $query = "INSERT INTO murid (nama, umur, kelas) VALUES('$nama','$umur','$kelas')";
