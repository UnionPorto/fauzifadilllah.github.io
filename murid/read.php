                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $dataketerangan['kelas']; ?></td>
                                      
                                                    <td><a href="../hapus/hapusketerangan.php?id_keterangan=<?php echo $dataketerangan['id']; ?>" class="btn btn-danger" ><i class="fas fa-trash"></i></a></center></td>
