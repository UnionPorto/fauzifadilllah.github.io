 ...
 <!DOCTYPE html>
    ...
    window.location.href = "../asset/approvecalender.php?kode_asset="+newtitle;
...
$koneksi    = mysqli_connect('localhost', 'root', '', 'invent');
//mengambil data dari tabel jadwal
$data       = mysqli_query($koneksi,'select * from item limit 20');
//melakukan looping
...
title: '<?php echo $d['Barcode']; ?>', //menampilkan title dari tabel
